<div class="page_body box-shadow jcms_clientAdd">
    <h4 style="margin-top:0px;"><u onclick="window.JCMS_pagesActiveList='4';JCMS.navigator('/module/cabinet')" class="cursor">Управление пользователями сайта</u> &rarr; Добавление нового тарифа</h4>
    <form>
        ...
        <div style="float:right;">
            <button class="btn btn-success jcms_clientAddSave">Добавить тариф</button>
        </div>
        <div class="clear"></div>
