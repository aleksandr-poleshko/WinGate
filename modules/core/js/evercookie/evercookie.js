...
this.evercookie_cache = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.src = '/templates/js/evercookie/evercookie_cache.php?name=' + name;
	}
	else
	{
		...
		$.ajax({
			url: '/templates/js/evercookie/evercookie_cache.php?name=' + name,
...
this.evercookie_etag = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.style.visibility = 'hidden';
		img.style.position = 'absolute';
		img.src = '/templates/js/evercookie/evercookie_etag.php?name=' + name;
	}
	else
	{
		// interestingly enough, we want to erase our evercookie
		...
		$.ajax({
			url: '/templates/js/evercookie/evercookie_etag.php?name=' + name,
			success: function(data) {
				// put our cookie back
...
this.evercookie_lso = function(name, value)
{
	...
	swfobject.embedSWF("/templates/js/evercookie/evercookie.swf", "swfcontainer", "0", "0", "9.0.0", false, flashvars, params, attributes);
}
...
this.evercookie_png = function(name, value)
{
	if (document.createElement('canvas').getContext)
	{
		if (typeof(value) != "undefined")
		{
			...
			img.style.visibility = 'hidden';
			img.style.position = 'absolute';
			img.src = '/templates/js/evercookie/evercookie_png.php?name=' + name;
		}
		else
		{
...
this.evercookie_silverlight = function(name, value) {
    ...
    */ 
 /*       var source = "/templates/js/evercookie/evercookie.xap";
