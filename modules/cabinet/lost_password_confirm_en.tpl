<div class="block_pages block_lk" style="width:280px; margin:0 auto;">
    <div class="text" align="center">
        ...
        <p align="left"><b>Enter the new password twice and click Next</b></p><br>
        <form class="jcms_clientForm" method="post">
            <input name="jcms_clientPassw1" value="" type="password" autofocus class="form-control bottom_stack" placeholder="Enter new password" style="width:250px;"><br />
            <input name="jcms_clientPassw2" value="" type="password" autofocus class="form-control bottom_stack" placeholder="Enter new password once again" style="width:250px;"><br />
            <img id="captcha_img" />
