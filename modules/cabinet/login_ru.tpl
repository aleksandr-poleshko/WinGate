<div class="block_pages block_lk" style="width:264px; margin:0 auto;">
    <div class="text" align="center">
        <h3 itemprop="name">Авторизация</h3><br />
        <div class="text">
			<form class="jcms_clientForm" id="jcms2LoginForm" method="post">
                <input name="jcms_clientLogin" type="text" required autofocus class="form-control bottom_stack" placeholder="Логин или email" value="{CABINET_LOGIN}" style="width:250px;"><br />
                <input type="password" class="form-control top_stack" name="jcms_clientPassword" required placeholder="Пароль" style="width:250px;">
           		<img id="captcha_img" />
                <input name="jcms_clientCaptcha" id="captcha_field" type="text" required placeholder="текст с картинки" style="width:250px;"><br />
                <button class="btn btn-lg btn-primary btn-block" type="submit" style="width:150px;">ВОЙТИ</button>
